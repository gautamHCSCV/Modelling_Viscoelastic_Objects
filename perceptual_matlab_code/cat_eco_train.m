...
F = [];
P = 'C:\Users\DELL\Downloads\Homogeneous_data_Access\Ecoflex_homogeneous_Sinusoidal_220414';
...
for i = 1:18
    ...
    t = f(i,1:35);
    m = 'C:\Users\DELL\Downloads\Homogeneous_data_Access\Ecoflex_homogeneous_Sinusoidal_220414\';
    y = append(m,t);
    Spill1 = importdata(y);
    x = Spill1(:,4);
    y = Spill1(:,16);
...
csvwrite('force_percep_cb_train_ecoflex.csv', D1);
csvwrite('pos_percep_cb_train_ecoflex.csv', D2);
