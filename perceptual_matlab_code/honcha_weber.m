...
F = [];
P = 'C:\Users\DELL\Downloads\Homogeneous_data\Dragonskin_homogeneous_Sinusoidal_210608';
...
for i = 55:81
    ...
    t = f(i,1:35);
    m = 'C:\Users\DELL\Downloads\Homogeneous_data\Dragonskin_homogeneous_Sinusoidal_210608\';
    y = append(m,t);
    Spill1 = importdata(y);
    x = Spill1(:,4);
    y = Spill1(:,16);
    ...
    %v1 = zeros( length(x), length(order));
...
D1 = horzcat(ind,res,f1);
D2 = horzcat(ind,res,dis1,vel1);

csvwrite('imp_force_percp_upd.csv', D1);
csvwrite('imp_pos_percep_upd.csv', D2);
