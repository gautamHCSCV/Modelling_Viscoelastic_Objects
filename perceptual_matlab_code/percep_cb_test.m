...
F = [];
P = 'C:\Users\DELL\Downloads\Homogeneous_data_Access\Dragonskin_homogeneous_Sinusoidal_220414_validation';
...
for i = 1:10
    ...
    t = f(i,1:76);
    m = 'C:\Users\DELL\Downloads\Homogeneous_data_Access\Dragonskin_homogeneous_Sinusoidal_220414_validation\';
    y = append(m,t);
    Spill1 = importdata(y);
    x = Spill1(:,4);
    y = Spill1(:,16);
...
csvwrite('force_percep_cb_test_dragon.csv', D1);
csvwrite('pos_percep_cb_test_dragon.csv', D2);
