F = [];
P = 'C:\Users\DELL\Downloads\Homogeneous_data\Ecoflex50_homogeneous_Sinusoidal_210608_validation';
...
for i = 1:10
t = F(i,1:78);
m = 'C:\Users\DELL\Downloads\Homogeneous_data\Ecoflex50_homogeneous_Sinusoidal_210608_validation\';
y = append(m,t);
Spill1 = importdata(y);
x = Spill1(:,4);
y = Spill1(:,16);
...
B = zeros( length(res), length(order));
for i = 1:length(order)
     yd = fderiv( res,order(i), 180,h );
...
csvwrite('out_other_up_test_whole_ecoflex_50.csv', force);
csvwrite('inp_deri_other_up_test_whole_ecoflex_50.csv', B);
